...
import IMMO_FINDER_FILTER_UPDATE from '@salesforce/messageChannel/ImmoFinderFilterUpdate__c';

export default class immoFinderFilter extends LightningElement {
    searchTerm = '';
    immobilien;
    immobilienIds;
    originalImmobilien;
    ...
    get kfwEnabled() {
     ...
     loadImmobilien(result) {
         ...
         if (result.data) {
             ...
             publish(this.messageContext, IMMO_FINDER_FILTER_UPDATE, message);
         }
     }
    ...
    handleFilters() {
        ...
        this.immobilien.data = this.deepCopyFunction(this.originalImmobilien.data).filter((immobilieWrapper) => {
